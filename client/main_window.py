...
class ClientMainWindow(QMainWindow):
    def __init__(self, database, transport, keys):
        ...
        # Даб. клик по листу контактов отправляется в обработчик
    ...
    def history_list_update(self):
        ...
        Заполнение модели записями, так-же стоит разделить входящие и 
         ...
         Записи в обратном порядке, поэтому выбираем их 
         с конца и не более 20
         """
    ...
    def set_active_user(self):
        '''Метод активации чатa с собеседником.
        '''
