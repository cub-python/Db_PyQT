...
from PyQt5.QtWidgets import QLabel, QPushButton, QLineEdit, QFileDialog, QDialog, QMessageBox


class ConfigWindow(QDialog):
    """window setting class"""
    ...
    def open_file_dialog(self):
        """обрабатывает открытия окна и выбирает папки"""
        global dialog
    ...
    def save_server_config(self):
        """метод сохр настроекю проверяет веденные
        данные и сохран ini file"""
