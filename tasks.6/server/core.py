...
#loading the logger(загрузка логера)
logger = logging.getLogger('server')

class MessageProcessor(threading.Thread):
    """основной класс сервера.работает в кач отдельного потока"""
    ...
    def remove_client(self, client):
        ...
        Ищет клиента и удаляет его из списка и базы """
    ...
    def service_update_lists(self):
            #Метод реализующий отправки сервисного сообщения 205
            # клиентам.
